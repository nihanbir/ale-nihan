...
const RsvpPage = () => {
    ...
    const [rsvpStatus, setRsvpStatus] = useState<'Yes' | 'No' | 'Pending'>(
        user?.rsvp?.status || 'Pending'
    );
    const [dietaryRequirements, setDietaryRequirements] = useState(
        user?.rsvp?.dietaryRequirements || ''
    );
    const [plusOne, setPlusOne] = useState(
        user?.rsvp?.plusOne || false
    );
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        userController.updateUser(user.username, {
            rsvp: updatedUser.rsvp
        });
                            ...
                            <div className="bg-white rounded-lg shadow-soft border border-wedding-accent/10 p-8">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="space-y-4">
                                        ...
                                        <RadioGroup
                                            value={rsvpStatus}
                                            onValueChange={(value: 'Yes' | 'No' | 'Pending') => setRsvpStatus(value)}
                                            className="space-y-2"
                                        >
                    ...
                    <div className="container max-w-4xl mx-auto px-6">
                        <AnimatedSection className="text-center" animation="fade-in">
                            ...
                            <div className="space-y-2 text-center">
                                ...
                                <div>
                                    Phone: <a href="tel:+46707314374" className="text-wedding-primary hover:underline">+46707314374</a>
                                </div>
                            </div>
                        </AnimatedSection>
                    </div>
