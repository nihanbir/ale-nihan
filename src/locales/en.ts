export default {
    ...
    details: {
        ...
        firstCourse: "Golden beet carpaccio",
        menuFirstCourse: "Chèvre cream, citronette, and roasted seeds",
        mainCourse: "Veal entrecôte",
        menuMainCourse: "Potato cake, herb/garlic butter, seasonal vegetables, and red wine sauce",
        dessert: "Raspberry mousse",
        menuDessert: "Accompaniments on the mousse",
        entertainmentDescription: "We've planned a wonderful evening of music and celebration for all our guests to enjoy.",
        schedule: "Schedule",
        dinner: "Dinner",
        dancing: "Dancing",
        ceremonyMusic: "",
        dinnerMusic: "Speeches",
        dancingDescription: "Dancing at the historical castle – with DJ Maylo Ma",
